...
// Address represents the 20 byte address of an Deltachain account.
...
// IsHexAddress verifies whdeltachain a string can represent a valid hex-encoded
// Deltachain address or not.
