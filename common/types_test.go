...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		// Test cases from https://github.com/deltachaineum/EIPs/blob/master/EIPS/eip-55.md#specification
...
func TestMixedcaseAccount_Address(t *testing.T) {
	...
	// https://github.com/deltachaineum/EIPs/blob/master/EIPS/eip-55.md
