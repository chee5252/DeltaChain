...
// Fuzz implements a go-fuzz fuzzer mdchod to test various encoding mdchod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mdchod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mdchod to test the bit decoding and
