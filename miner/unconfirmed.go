...
// chainRetriever is used by the unconfirmed block set to verify whdeltachain a previously
...
func (set *unconfirmedBlocks) Shift(height uint64) {
	...
	for set.blocks != nil {
		...
		default:
			// Block is not canonical, check whdeltachain we have an uncle or a lost block
			included := false
