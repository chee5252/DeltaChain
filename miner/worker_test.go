...
var (
	...
	dchashChainConfig *params.ChainConfig
...
func init() {
	...
	dchashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setDeltachainbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockEthash(t *testing.T) {
	testPendingStateAndBlock(t, dchashChainConfig, dchash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, dchdb.NewMemDatabase()))
}
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, dchashChainConfig, dchash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, dchdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	dchash := dchash.NewFaker()
	defer dchash.Close()

	w, b := newTestWorker(t, dchashChainConfig, dchash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, dchashChainConfig, dchash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, dchdb.NewMemDatabase()))
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, dchashChainConfig, dchash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, dchdb.NewMemDatabase()))
}
