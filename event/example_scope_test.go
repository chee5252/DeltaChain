...
// The app's SubscribeResults mdchod starts sending calculation results to the given
// channel. Subscriptions created through this mdchod are tied to the lifetime of the App
