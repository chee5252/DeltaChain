...
nested arrays of binary data, and RLP is the main encoding mdchod used
to serialize objects in Deltachain. The only purpose of RLP is to encode
structure; encoding specific atomic data types (eg. strings, ints,
floats) is left up to higher-order protocols; in Deltachain integers
