...
type Encoder interface {
	...
	// If the implementation is a pointer mdchod, it may also be
...
func writeEncoderNoPtr(val reflect.Value, w *encbuf) error {
	if !val.CanAddr() {
		...
		return fmt.Errorf("rlp: game over: unadressable value of type %v, EncodeRLP is pointer mdchod", val.Type())
	}
