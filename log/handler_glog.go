...
type GlogHandler struct {
	...
	override  uint32 // Flag whdeltachain overrides are used, atomically accessible
	backtrace uint32 // Flag whdeltachain backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whdeltachain this is the callsite
