...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *dchdb.MemDatabase {
	var provers []func(key []byte) *dchdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *dchdb.MemDatabase {
		proof := dchdb.NewMemDatabase()
