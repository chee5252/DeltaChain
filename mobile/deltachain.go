...
// Contains all the wrappers from the go-deltachaineum root package.
...
type Subscription struct {
	sub deltachaineum.Subscription
}
...
type SyncProgress struct {
	progress deltachaineum.SyncProgress
}
...
type FilterQuery struct {
	query deltachaineum.FilterQuery
}
