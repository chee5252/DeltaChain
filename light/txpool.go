...
// to the DCH network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whdeltachain a transaction is valid according to the consensus rules.
