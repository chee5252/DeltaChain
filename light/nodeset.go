...
func (db *NodeSet) Store(target dchdb.Putter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements dchdb.Putter.
type NodeList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db dchdb.Putter) {
	for _, node := range n {
