...
func TestTxPool(t *testing.T) {
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, dchash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, dchash.NewFullFaker())
	txPermanent = 50
