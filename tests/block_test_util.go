...
// Package tests implements execution of Deltachain JSON tests.
package tests
...
/* See https://github.com/deltachaineum/tests/wiki/Blockchain-Tests-II

   Whdeltachain a block is valid or not is a bit subtle, it's defined by presence of
