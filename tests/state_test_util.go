...
// See https://github.com/deltachaineum/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	statedb := MakePreState(dchdb.NewMemDatabase(), t.json.Pre)
...
func MakePreState(db dchdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/deltachaineum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
