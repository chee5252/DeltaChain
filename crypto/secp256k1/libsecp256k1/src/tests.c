...
#ifndef USE_NUM_NONE
    {
        /* Test that adding the scalars togdeltachain is equal to adding their numbers togdeltachain modulo the order. */
        secp256k1_num rnum;
        secp256k1_num r2num;
        secp256k1_scalar r;
...
void test_ge(void) {
     ...
     * All 17*17 combinations of points are added to each other, using all applicable mdchods.
     *
    ...
    /* Test adding all points togdeltachain in random order equals infinity. */
    {
