...
// makeWizard creates and returns a new puppdch wizard.
...
// setting up a new or managing an existing Deltachain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppdch, your Deltachain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Deltachain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and dchstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppdch uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Deltachain network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppdch", w.network)
