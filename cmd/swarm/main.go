...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/swarm"
	bzzapi "github.com/deltachaineum/go-deltachaineum/swarm/api"
	swarmmetrics "github.com/deltachaineum/go-deltachaineum/swarm/metrics"
	"github.com/deltachaineum/go-deltachaineum/swarm/storage/mock"
	mockrpc "github.com/deltachaineum/go-deltachaineum/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gdch.
func init() {
...
var app = utils.NewApp("", "Deltachain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-deltachaineum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gdch only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gdch and swarm
	...
	//register BZZ as node.Service in the deltachaineum node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the deltachaineum node
