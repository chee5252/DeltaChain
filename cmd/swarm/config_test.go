...
func TestConfigValidate(t *testing.T) {
	for _, c := range []struct {
		...
		{
			cfg: &api.Config{EnsAPIs: []string{
				"314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gdch.ipc",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
		...
		{
			cfg: &api.Config{EnsAPIs: []string{
				"test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gdch.ipc",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
				"dch:314159265dD8dbb310642f98f50C066173C1259b@http://127.0.0.1:1234",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
				"dch:314159265dD8dbb310642f98f50C066173C1259b@ws://127.0.0.1:12344",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
			...
			err: "invalid format [tld:][contract-addr@]url for ENS API endpoint configuration \"dch:\": missing url",
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
		...
		},
		{
			...
			err: "invalid format [tld:][contract-addr@]url for ENS API endpoint configuration \"@/data/testnet/gdch.ipc\": missing contract address",
		},
	} {
