...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.deltachaineum/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.deltachaineum/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
		},
		{
			Action:             dbImport,
    ...
    swarm db import ~/.deltachaineum/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.deltachaineum/swarm/bzz-KEY/chunks -`,
		},
	},
}
