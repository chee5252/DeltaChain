...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/crypto/ecies"
	"github.com/deltachaineum/go-deltachaineum/log"
	"github.com/deltachaineum/go-deltachaineum/swarm/api"
	swarmapi "github.com/deltachaineum/go-deltachaineum/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be somdching here")
	}
...
// the specs at https://github.com/deltachainsphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
