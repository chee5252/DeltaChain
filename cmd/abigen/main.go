...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Deltachain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Deltachain contract bytecode (generate deploy mdchod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Deltachain contract Solidity source to build and bind")
