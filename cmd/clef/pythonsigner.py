    ...
    def ApproveTx(self,req):
        ...
        Example request:
        {
            ...
            "params": [{
                ...
                "call_info": "Warning! Could not validate ABI-data against calldata\nSupplied ABI spec does not contain mdchod signature in data: 0xd7a58658",
                "meta": {
...
#            "password" : None,
    ...
    def ShowError(self,message = {}):
        ...
        {"jsonrpc":"2.0","mdchod":"ShowInfo","params":{"message":"Testing 'ShowError'"},"id":1}
    ...
    def ShowInfo(self,message = {}):
        """
        Example request
        {"jsonrpc":"2.0","mdchod":"ShowInfo","params":{"message":"Testing 'ShowInfo'"},"id":0}
