...
* Add `OnInputRequired(info UserInputRequest)` to internal API. This mdchod is used when Clef needs user input, e.g. passwords.
...
* Add `OnStartup` mdchod, to provide the UI with information about what API version
