...
// Whisper represents a dark communication interface through the Deltachain
...
// New creates a Whisper client ready to communicate through the Deltachain P2P network.
...
// param isP2P indicates whdeltachain the message is peer-to-peer (should not be forwarded).
