...
// mdchod triggerings. In the affected component's shouldComponentUpdate mdchod it can be checked
// whdeltachain the involved data was changed or not by checking the message structure.
//
