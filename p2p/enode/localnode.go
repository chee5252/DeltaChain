...
// current process. Setting ENR entries via the Set mdchod updates the record. A new version
// of the record is signed on demand when the Node mdchod is called.
