...
type packet interface {
	// preverify checks whdeltachain the packet is valid and should be handled at all.
...
type replyMatcher struct {
	...
	// reply was acceptable. The second return value indicates whdeltachain the callback should
...
type reply struct {
	...
	// loop indicates whdeltachain there was
...
// whdeltachain any matcher considered the packet acceptable.
...
func (t *udp) loop() {
	...
	for {
		...
		case r := <-t.gotreply:
			var matched bool // whdeltachain any replyMatcher considered the reply acceptable.
			for el := plist.Front(); el != nil; el = el.Next() {
