...
// Package p2p implements the Deltachain p2p network protocols.
package p2p
...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/p2p/discover"
	"github.com/deltachaineum/go-deltachaineum/p2p/discv5"
	"github.com/deltachaineum/go-deltachaineum/p2p/enode"
	"github.com/deltachaineum/go-deltachaineum/p2p/enr"
...
type Config struct {
	...
	// DiscoveryV5 specifies whdeltachain the new topic-discovery based V5 discovery
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "deltachaineum discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "deltachaineum p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Deltachain Node Record
