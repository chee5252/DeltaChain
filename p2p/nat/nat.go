...
type Interface interface {
	// These mdchods manage a mapping between a port on the local
	...
	// This mdchod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the mdchod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whdeltachain the local machine has an
...
// auto-discovered. Calls to the Interface mdchods on this type will
// wait until the discovery is done and then call the mdchod on the
