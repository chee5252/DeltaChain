...
// Package enr implements Deltachain Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whdeltachain the record is signed using the given identity scheme.
