...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/crypto/secp256k1"
...
// and also verifies whdeltachain the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whdeltachain read packet had plain format.
