...
// Contains reports whdeltachain the given IP is contained in the list.
...
// IsLAN reports whdeltachain an IP is a local network address.
...
// IsSpecialNetwork reports whdeltachain an IP is located in a special-use network range
...
// CheckRelayIP reports whdeltachain an IP relayed from the given sender IP
...
// SameNet reports whdeltachain two IP addresses have an equal prefix of the given bit length.
...
// Contains whdeltachain the given IP is contained in the set.
