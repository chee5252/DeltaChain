...
// PredictFullConeNAT checks whdeltachain the local host is behind full cone NAT. It predicts by
// checking whdeltachain any statement has been received from a node we didn't contact before
