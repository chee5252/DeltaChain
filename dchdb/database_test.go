...
func newTestLDB() (*dchdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "dchdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := dchdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(dchdb.NewMemDatabase(), t)
}

func testPutGet(db dchdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(dchdb.NewMemDatabase(), t)
}

func testParallelPutGet(db dchdb.Database, t *testing.T) {
	const n = 8
