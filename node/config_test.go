...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdch.ipc", false, filepath.Join(os.TempDir(), "gdch.ipc")},
		{"data", "gdch.ipc", false, "data/gdch.ipc"},
		{"data", "./gdch.ipc", false, "./gdch.ipc"},
		{"data", "/gdch.ipc", false, "/gdch.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdch.ipc", true, `\\.\pipe\gdch.ipc`},
		{"data", "gdch.ipc", true, `\\.\pipe\gdch.ipc`},
		{"data", `\\.\pipe\gdch.ipc`, true, `\\.\pipe\gdch.ipc`},
	}
