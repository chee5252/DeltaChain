...
// PrivateAdminAPI is the collection of administrative API mdchods exposed only
// over a secure RPC channel.
type PrivateAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPrivateAdminAPI creates a new API definition for the private admin mdchods
// of the node itself.
...
// PublicAdminAPI is the collection of administrative API mdchods exposed over
// both secure and unsecure RPC channels.
type PublicAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPublicAdminAPI creates a new API definition for the public admin mdchods
// of the node itself.
...
// PublicDebugAPI is the collection of debugging related API mdchods exposed over
// both secure and unsecure RPC channels.
...
// Sha3 applies the deltachaineum sha3 implementation on the input.
