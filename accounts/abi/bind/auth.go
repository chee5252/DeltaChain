...
// NewTransactor is a utility mdchod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility mdchod to easily create a transaction signer
