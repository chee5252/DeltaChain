...
// Package accounts implements high level Deltachain account management.
package accounts
...
// Account represents an Deltachain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Deltachain account address derived from the key
...
type Wallet interface {
	...
	// particular wallet instance. The reason there is no passwordless open mdchod
	...
	// Contains returns whdeltachain an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain deltachaineum.ChainStateReader)
