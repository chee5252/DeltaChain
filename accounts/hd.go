...
// the `coin_type` 60' (or 0x8000003C) to Deltachain.
//
// The root path for Deltachain is m/44'/60'/0'/0 according to the specification
// from https://github.com/deltachaineum/EIPs/issues/84, albeit it's not set in stone
// yet whdeltachain accounts should increment the last component or the children of
