...
const (
	...
	MessageType_MessageType_DeltachainGetAddress       MessageType = 56
	MessageType_MessageType_DeltachainAddress          MessageType = 57
	MessageType_MessageType_DeltachainSignTx           MessageType = 58
	MessageType_MessageType_DeltachainTxRequest        MessageType = 59
	MessageType_MessageType_DeltachainTxAck            MessageType = 60
	...
	MessageType_MessageType_DeltachainSignMessage      MessageType = 64
	MessageType_MessageType_DeltachainVerifyMessage    MessageType = 65
	MessageType_MessageType_DeltachainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_DeltachainGetAddress",
	57:  "MessageType_DeltachainAddress",
	58:  "MessageType_DeltachainSignTx",
	59:  "MessageType_DeltachainTxRequest",
	60:  "MessageType_DeltachainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_DeltachainSignMessage",
	65:  "MessageType_DeltachainVerifyMessage",
	66:  "MessageType_DeltachainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_DeltachainGetAddress":       56,
	"MessageType_DeltachainAddress":          57,
	"MessageType_DeltachainSignTx":           58,
	"MessageType_DeltachainTxRequest":        59,
	"MessageType_DeltachainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_DeltachainSignMessage":      64,
	"MessageType_DeltachainVerifyMessage":    65,
	"MessageType_DeltachainMessageSignature": 66,
...
// *
// Request: Ask device for Deltachain address corresponding to address_n path
// @next PassphraseRequest
// @next DeltachainAddress
// @next Failure
type DeltachainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DeltachainGetAddress) Reset()                    { *m = DeltachainGetAddress{} }
func (m *DeltachainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*DeltachainGetAddress) ProtoMessage()               {}
func (*DeltachainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *DeltachainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DeltachainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Deltachain address derived from device private seed
// @prev DeltachainGetAddress
type DeltachainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DeltachainAddress) Reset()                    { *m = DeltachainAddress{} }
func (m *DeltachainAddress) String() string            { return proto.CompactTextString(m) }
func (*DeltachainAddress) ProtoMessage()               {}
func (*DeltachainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *DeltachainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type RecoveryDevice struct {
	...
	// 7 reserved for unused recovery mdchod
...
// This mdchod doesn't support streaming, so there are hardware limits in number of inputs and outputs.
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next DeltachainTxRequest
// @next Failure
type DeltachainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *DeltachainSignTx) Reset()                    { *m = DeltachainSignTx{} }
func (m *DeltachainSignTx) String() string            { return proto.CompactTextString(m) }
func (*DeltachainSignTx) ProtoMessage()               {}
func (*DeltachainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *DeltachainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DeltachainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *DeltachainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *DeltachainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *DeltachainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *DeltachainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *DeltachainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *DeltachainSignTx) GetDataLength() uint32 {
...
func (m *DeltachainSignTx) GetChainId() uint32 {
...
// @prev DeltachainSignTx
// @next DeltachainTxAck
type DeltachainTxRequest struct {
...
func (m *DeltachainTxRequest) Reset()                    { *m = DeltachainTxRequest{} }
func (m *DeltachainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*DeltachainTxRequest) ProtoMessage()               {}
func (*DeltachainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *DeltachainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *DeltachainTxRequest) GetSignatureV() uint32 {
...
func (m *DeltachainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *DeltachainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev DeltachainTxRequest
// @next DeltachainTxRequest
type DeltachainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DeltachainTxAck) Reset()                    { *m = DeltachainTxAck{} }
func (m *DeltachainTxAck) String() string            { return proto.CompactTextString(m) }
func (*DeltachainTxAck) ProtoMessage()               {}
func (*DeltachainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *DeltachainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next DeltachainMessageSignature
// @next Failure
type DeltachainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DeltachainSignMessage) Reset()                    { *m = DeltachainSignMessage{} }
func (m *DeltachainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*DeltachainSignMessage) ProtoMessage()               {}
func (*DeltachainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *DeltachainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DeltachainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type DeltachainVerifyMessage struct {
...
func (m *DeltachainVerifyMessage) Reset()                    { *m = DeltachainVerifyMessage{} }
func (m *DeltachainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*DeltachainVerifyMessage) ProtoMessage()               {}
func (*DeltachainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *DeltachainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DeltachainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *DeltachainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev DeltachainSignMessage
type DeltachainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DeltachainMessageSignature) Reset()                    { *m = DeltachainMessageSignature{} }
func (m *DeltachainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*DeltachainMessageSignature) ProtoMessage()               {}
func (*DeltachainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *DeltachainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DeltachainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DeltachainGetAddress)(nil), "DeltachainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*DeltachainAddress)(nil), "DeltachainAddress")
	...
	proto.RegisterType((*DeltachainSignTx)(nil), "DeltachainSignTx")
	proto.RegisterType((*DeltachainTxRequest)(nil), "DeltachainTxRequest")
	proto.RegisterType((*DeltachainTxAck)(nil), "DeltachainTxAck")
	proto.RegisterType((*DeltachainSignMessage)(nil), "DeltachainSignMessage")
	proto.RegisterType((*DeltachainVerifyMessage)(nil), "DeltachainVerifyMessage")
	proto.RegisterType((*DeltachainMessageSignature)(nil), "DeltachainMessageSignature")
