...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("dch-keystore-watch-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestCacheAddDeleteOrder(t *testing.T) {
	...
	accs := []accounts.Account{
		...
		},
		{
			...
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "SOMDCHING.key"},
		},
		{
			Address: common.HexToAddress("7ef5a6135f1fd6a02593eedc869c6d41d934aef8"),
	...
	cache.delete(accounts.Account{Address: common.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e"), URL: accounts.URL{Scheme: KeyStoreScheme, Path: "somdching"}})
...
func TestCacheFind(t *testing.T) {
	...
	nomatchAccount := accounts.Account{
		Address: common.HexToAddress("f466859ead1932d743d622cb74fc058882e8648a"),
		URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(dir, "somdching")},
	}
	tests := []struct {
