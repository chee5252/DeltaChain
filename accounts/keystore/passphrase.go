...
The crypto is documented at https://github.com/deltachaineum/wiki/wiki/Web3-Secret-Storage-Definition
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/deltachaineum/go-deltachaineum/issues." +
				"The error was : %s"
