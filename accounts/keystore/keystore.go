...
// See https://github.com/deltachaineum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whdeltachain the event notification loop is running
...
// HasAddress reports whdeltachain a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Deltachain presale wallet and stores
