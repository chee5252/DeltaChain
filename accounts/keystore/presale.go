...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/deltachaineum/pydchsaletool

		pydchsaletool generates the encryption key from password by
	...
	*/
	...
	dchPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(dchPriv)
