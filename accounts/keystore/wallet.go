...
// Status implements accounts.Wallet, returning whdeltachain the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain deltachaineum.ChainStateReader) {}
