...
type accessTestFn func(db dchdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db dchdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db dchdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db dchdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db dchdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
