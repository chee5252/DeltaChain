...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/les/flowcontrol"
...
func testIndexers(db dchdb.Database, odr light.OdrBackend, iConfig *light.IndexerConfig) (*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer) {
	chtIndexer := light.NewChtIndexer(db, odr, iConfig.ChtSize, iConfig.ChtConfirms)
	bloomIndexer := dch.NewBloomIndexer(db, iConfig.BloomSize, iConfig.BloomConfirms)
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db dchdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		gchain, _ := core.GenerateChain(gspec.Config, genesis, dchash.NewFaker(), db, blocks, generator)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db dchdb.Database) *ProtocolManager {
...
func newClientServerEnv(t *testing.T, blocks int, protocol int, waitIndexers func(*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer), newPeer bool) (*TestEntity, *TestEntity, func()) {
	db, ldb := dchdb.NewMemDatabase(), dchdb.NewMemDatabase()
