...
// NodeInfo represents a short summary of the Deltachain sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64                   `json:"network"`    // Deltachain network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
