...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/swarm/network/stream/intervals"
...
// setNextBatch adjusts passed interval based on session index and whdeltachain
...
// the price for a message via the Price mdchod
