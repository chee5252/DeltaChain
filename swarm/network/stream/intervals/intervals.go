...
// mdchods to add new intervals and retrieve missing intervals that
// need to be added.
...
// No range bellow start bound will be added by Add mdchod or
// returned by Next mdchod. This limit may be used for
