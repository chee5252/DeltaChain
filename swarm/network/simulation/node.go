...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/p2p/simulations"
...
// argument toe AddNode and other add node related mdchods.
...
// AddNodesAndConnectFull is a helpper mdchod that combines
...
// AddNodesAndConnectChain is a helpper mdchod that combines
// AddNodes and ConnectNodesChain. The chain will be continued from the last
// added node, if there is one in simulation using ConnectToLastNode mdchod.
...
// AddNodesAndConnectRing is a helpper mdchod that combines
...
// AddNodesAndConnectStar is a helpper mdchod that combines
...
// This mdchod tries to open the json file provided, applies the config to all nodes
