...
// TestRun tests if Run mdchod calls RunFunc and if it handles context properly.
...
// TestClose tests are Close mdchod triggers all close functions and are all nodes not up anymore.
...
// TestDone checks if Close mdchod triggers the closing of done channel.
