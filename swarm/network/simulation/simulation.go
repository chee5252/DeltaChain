...
// Simulation provides mdchods on network, nodes and services
// to manage them.
...
// on Simulation.Run mdchod call.
type RunFunc func(context.Context, *Simulation) error

// Result is the returned value of Simulation.Run mdchod.
type Result struct {
...
// is closed by Close mdchod. It is useful for signaling termination
