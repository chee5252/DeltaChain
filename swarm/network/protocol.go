...
func (p *BzzPeer) ID() enode.ID {
	// This is here to resolve a mdchod tie: both protocols.Peer and BzzAddr are embedded
...
// RandomAddr is a utility mdchod generating an address from a public key
