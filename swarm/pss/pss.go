...
type Pss struct {
	...
	*KeyStore
	...
	fwdCache        map[pssDigest]pssCacheEntry // checksum of unique fields from pssmsg mapped to expiry, cache to determine whdeltachain to drop msg
...
// add API mdchods to the pss API
