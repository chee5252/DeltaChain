...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/swarm/pot"
...
// matching of address hints; whdeltachain a message could be or is for the node
...
func TestAddressMatchProx(t *testing.T) {
	...
	// first the unit test on the mdchod that calculates possible receipient using prox
