...
//
// IO is performed using the ordinary p2p.MsgReadWriter interface, which transparently communicates with a pss node via RPC using websockets as transport layer, using mdchods in the PssAPI class in the swarm/pss package
//
//
...
//  	"fmt"
//  	"os"
//  	pss "github.com/deltachaineum/go-deltachaineum/swarm/pss/client"
...
//
//      // use the protocol for somdching
//
//      psc.Stop()
//  }
//
