...
see https://github.com/deltachaineum/go-deltachaineum/issues/2040
Usage:

import (
 "github.com/deltachaineum/go-deltachaineum/common/httpclient"
 "github.com/deltachaineum/go-deltachaineum/swarm/api/http"
)
...
func (self *RoundTripper) RoundTrip(req *http.Request) (resp *http.Response, err error) {
	...
	reqProxy, err := http.NewRequest(req.Mdchod, url, req.Body)
	if err != nil {
		return nil, err
	}
