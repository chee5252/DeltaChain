...
it is the public interface of the FileStore which is included in the deltachaineum stack
*/
type API struct {
	feed      *feed.Handler
...
// ErrNotAFeedManifest is returned when the address provided returned somdching other than a valid manifest
