...
// GlobalStorer defines mdchods for mock db store
...
// Importer defines mdchod for importing mock store data
// from an exported tar archive.
type Importer interface {
	Import(r io.Reader) (n int, err error)
}

// Exporter defines mdchod for exporting mock store data
// to a tar archive.
