...
// This mdchod will check if the chunk is already in the MemStore
// and it will return it if it is. If there is an error from
// the MemStore.Get, it will be returned by calling GetErrored
// on the chunk.
// This mdchod is responsible for closing Chunk.ReqC channel
...
// This mdchod is blocking until the chunk is retrieved
