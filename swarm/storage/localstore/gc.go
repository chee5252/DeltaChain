...
be counted into garbage collection size, which determines whdeltachain a number of
...
panic happen, or database Close mdchod is not saved. The database storage
