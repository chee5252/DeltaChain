// Copyright 2019 The go-deltachaineum Authors
...
The main type is DB which manages the storage by providing mdchods to
...
that provides adequate mdchod to perform the opperation and that type
...
Subscription mdchods are implemented for a specific purpose of
