...
We want to build go-deltachaineum with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Edeltachaineum/+archive/ubuntu/deltachaineum/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/deltachaineum-unstable-1.6.0+xenial
    $ dpkg-buildpackage

Built packages are placed in the dist/ directory.

    $ cd ..
    $ dpkg-deb -c gdch-unstable_1.6.0+xenial_amd64.deb
