Name "gdch ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/deltachaineum/go-deltachaineum/issues"
!define UPDATEURL "https://github.com/deltachaineum/go-deltachaineum/releases"
!define ABOUTURL "https://github.com/deltachaineum/go-deltachaineum#deltachaineum-go"
...
# Install gdch binary
Section "Gdch" GDCH_IDX
  SetOutPath $INSTDIR
  file {{.Gdch}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdch.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdch.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gdch incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdch outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdch UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gdch incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gdch.exe" "" "" "Deltachain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gdch outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gdch.exe" "" "" "Deltachain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gdch UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gdch.exe" "" "" "Deltachain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/deltachaineum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "DELTACHAIN_SOCKET" "R" "HKLM" "\\.\pipe\gdch.ipc"
  ${EnvVarUpdate} $0 "DELTACHAIN_SOCKET" "A" "HKLM" "\\.\pipe\gdch.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GDCH_IDX}
    SectionGetSize ${GDCH_IDX} $0
