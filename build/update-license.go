...
Please review the resulting diff to check whdeltachain the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-deltachaineum authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-deltachaineum Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-deltachaineum"
	}
	if startOfSentence {
		return "The go-deltachaineum library"
	}
	return "the go-deltachaineum library"
}
