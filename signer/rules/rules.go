...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/signer/rules/deps"
...
// file for each defined UI-mdchod
...
func (r *rulesetUI) OnApprovedTx(tx dchapi.SignTransactionResult) {
