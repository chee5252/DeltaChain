...
func (ui *StdIOUI) dispatch(serviceMdchod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMdchod, args)
	if err != nil {
...
func (ui *StdIOUI) OnApprovedTx(tx dchapi.SignTransactionResult) {
