...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mdchodSelector *string) (*dchapi.SignTransactionResult, error) {
	sel := "<nil>"
	...
	res, e := l.api.SignTransaction(ctx, args, mdchodSelector)
	if res != nil {
