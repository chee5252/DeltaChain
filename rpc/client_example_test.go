...
// known to the server. The server supports two mdchods:
//
// dch_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// dch_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "dch_getBlockByNumber", "latest"); err != nil {
