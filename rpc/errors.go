...
type mdchodNotFoundError struct {
	service string
	mdchod  string
}

func (e *mdchodNotFoundError) ErrorCode() int { return -32601 }

func (e *mdchodNotFoundError) Error() string {
	return fmt.Sprintf("The mdchod %s%s%s does not exist/is not available", e.service, serviceMdchodSeparator, e.mdchod)
}
