...
func testServerMdchodExecution(t *testing.T, mdchod string) {
	server := NewServer()
	service := new(Service)
	...
	go server.ServeCodec(NewJSONCodec(serverConn), OptionMdchodInvocation)
...
func TestServerMdchodExecution(t *testing.T) {
	testServerMdchodExecution(t, "echo")
}

func TestServerMdchodWithCtx(t *testing.T) {
	testServerMdchodExecution(t, "echoWithCtx")
}
