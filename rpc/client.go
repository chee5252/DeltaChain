...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout dch_subscribe, rpc_modules calls
)
...
type jsonrpcMessage struct {
	...
	Mdchod  string          `json:"mdchod,omitempty"`
...
func (msg *jsonrpcMessage) isNotification() bool {
	return msg.ID == nil && msg.Mdchod != ""
}

func (msg *jsonrpcMessage) isResponse() bool {
	return msg.hasValidID() && msg.Mdchod == "" && len(msg.Params) == 0
}
...
// SupportedModules calls the rpc_modules mdchod, retrieving the list of
...
func (c *Client) Call(result interface{}, mdchod string, args ...interface{}) error {
	ctx := context.Background()
	return c.CallContext(ctx, result, mdchod, args...)
}
...
// The result must be a pointer so that package json can unmarshal into it. You
// can also pass nil, in which case the result is ignored.
func (c *Client) CallContext(ctx context.Context, result interface{}, mdchod string, args ...interface{}) error {
	msg, err := c.newMessage(mdchod, args...)
	if err != nil {
		return err
	}
...
func (c *Client) BatchCallContext(ctx context.Context, b []BatchElem) error {
	...
	for i, elem := range b {
		msg, err := c.newMessage(elem.Mdchod, elem.Args...)
		if err != nil {
			return err
		}
		msgs[i] = msg
...
// EthSubscribe registers a subscripion under the "dch" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "dch", channel, args...)
}
...
// Subscribe calls the "<namespace>_subscribe" mdchod with the given arguments,
...
func (c *Client) Subscribe(ctx context.Context, namespace string, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	...
	msg, err := c.newMessage(namespace+subscribeMdchodSuffix, args...)
	if err != nil {
		return nil, err
	}
	op := &requestOp{
...
func (c *Client) newMessage(mdchod string, paramsIn ...interface{}) (*jsonrpcMessage, error) {
	params, err := json.Marshal(paramsIn)
	if err != nil {
		return nil, err
	}
	return &jsonrpcMessage{Version: "2.0", ID: c.nextID(), Mdchod: mdchod, Params: params}, nil
}
...
func (c *Client) handleNotification(msg *jsonrpcMessage) {
	if !strings.HasSuffix(msg.Mdchod, notificationMdchodSuffix) {
...
func (sub *ClientSubscription) requestUnsubscribe() error {
	...
	return sub.client.Call(&result, sub.namespace+unsubscribeMdchodSuffix, sub.subid)
}
