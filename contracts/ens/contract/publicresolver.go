...
// DeployPublicResolver deploys a new Deltachain contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an Deltachain contract.
...
// PublicResolverCaller is an auto generated read-only Go binding around an Deltachain contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an Deltachain contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverFilterer is an auto generated log filtering Go binding around an Deltachain contract events.
type PublicResolverFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an Deltachain contract,
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an Deltachain contract,
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an Deltachain contract,
...
// PublicResolverRaw is an auto generated low-level Go binding around an Deltachain contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw mdchods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an Deltachain contract.
type PublicResolverCallerRaw struct {
	Contract *PublicResolverCaller // Generic read-only contract binding to access the raw mdchods on
}

// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an Deltachain contract.
type PublicResolverTransactorRaw struct {
	Contract *PublicResolverTransactor // Generic write-only contract binding to access the raw mdchods on
}
...
// returns.
func (_PublicResolver *PublicResolverRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _PublicResolver.Contract.PublicResolverCaller.contract.Call(opts, result, mdchod, params...)
}
...
func (_PublicResolver *PublicResolverRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _PublicResolver.Contract.PublicResolverTransactor.contract.Transact(opts, mdchod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_PublicResolver *PublicResolverCallerRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _PublicResolver.Contract.contract.Call(opts, result, mdchod, params...)
}
...
// Transact invokes the (paid) contract mdchod with params as input values.
func (_PublicResolver *PublicResolverTransactorRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _PublicResolver.Contract.contract.Transact(opts, mdchod, params...)
}

// ABI is a free data retrieval call binding the contract mdchod 0x2203ab56.
//
...
// Addr is a free data retrieval call binding the contract mdchod 0x3b3b57de.
//
...
// Content is a free data retrieval call binding the contract mdchod 0x2dff6941.
//
...
// Name is a free data retrieval call binding the contract mdchod 0x691f3431.
//
...
// Pubkey is a free data retrieval call binding the contract mdchod 0xc8690233.
//
...
// SupportsInterface is a free data retrieval call binding the contract mdchod 0x01ffc9a7.
//
...
// Text is a free data retrieval call binding the contract mdchod 0x59d1d43c.
//
...
// SetABI is a paid mutator transaction binding the contract mdchod 0x623195b0.
//
...
// SetAddr is a paid mutator transaction binding the contract mdchod 0xd5fa2b00.
//
...
// SetContent is a paid mutator transaction binding the contract mdchod 0xc3d014d6.
//
...
// SetName is a paid mutator transaction binding the contract mdchod 0x77372213.
//
...
// SetPubkey is a paid mutator transaction binding the contract mdchod 0x29cd62ea.
//
...
// SetText is a paid mutator transaction binding the contract mdchod 0x10f13a8c.
//
