...
// DeployFIFSRegistrar deploys a new Deltachain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Deltachain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Deltachain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Deltachain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Deltachain contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Deltachain contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Deltachain contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Deltachain contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Deltachain contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw mdchods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Deltachain contract.
type FIFSRegistrarCallerRaw struct {
	Contract *FIFSRegistrarCaller // Generic read-only contract binding to access the raw mdchods on
}

// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Deltachain contract.
type FIFSRegistrarTransactorRaw struct {
	Contract *FIFSRegistrarTransactor // Generic write-only contract binding to access the raw mdchods on
}
...
// returns.
func (_FIFSRegistrar *FIFSRegistrarRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.FIFSRegistrarCaller.contract.Call(opts, result, mdchod, params...)
}
...
func (_FIFSRegistrar *FIFSRegistrarRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.FIFSRegistrarTransactor.contract.Transact(opts, mdchod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_FIFSRegistrar *FIFSRegistrarCallerRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.contract.Call(opts, result, mdchod, params...)
}
...
// Transact invokes the (paid) contract mdchod with params as input values.
func (_FIFSRegistrar *FIFSRegistrarTransactorRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.contract.Transact(opts, mdchod, params...)
}

// Register is a paid mutator transaction binding the contract mdchod 0xd22057a9.
//
