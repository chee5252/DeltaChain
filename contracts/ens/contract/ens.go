...
// DeployENS deploys a new Deltachain contract, binding an instance of ENS to it.
...
// ENS is an auto generated Go binding around an Deltachain contract.
type ENS struct {
...
// ENSCaller is an auto generated read-only Go binding around an Deltachain contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an Deltachain contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSFilterer is an auto generated log filtering Go binding around an Deltachain contract events.
type ENSFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an Deltachain contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an Deltachain contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an Deltachain contract,
...
// ENSRaw is an auto generated low-level Go binding around an Deltachain contract.
type ENSRaw struct {
	Contract *ENS // Generic contract binding to access the raw mdchods on
}

// ENSCallerRaw is an auto generated low-level read-only Go binding around an Deltachain contract.
type ENSCallerRaw struct {
	Contract *ENSCaller // Generic read-only contract binding to access the raw mdchods on
}

// ENSTransactorRaw is an auto generated low-level write-only Go binding around an Deltachain contract.
type ENSTransactorRaw struct {
	Contract *ENSTransactor // Generic write-only contract binding to access the raw mdchods on
}
...
// returns.
func (_ENS *ENSRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _ENS.Contract.ENSCaller.contract.Call(opts, result, mdchod, params...)
}
...
func (_ENS *ENSRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _ENS.Contract.ENSTransactor.contract.Transact(opts, mdchod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ENS *ENSCallerRaw) Call(opts *bind.CallOpts, result interface{}, mdchod string, params ...interface{}) error {
	return _ENS.Contract.contract.Call(opts, result, mdchod, params...)
}
...
// Transact invokes the (paid) contract mdchod with params as input values.
func (_ENS *ENSTransactorRaw) Transact(opts *bind.TransactOpts, mdchod string, params ...interface{}) (*types.Transaction, error) {
	return _ENS.Contract.contract.Transact(opts, mdchod, params...)
}

// Owner is a free data retrieval call binding the contract mdchod 0x02571be3.
//
...
// Resolver is a free data retrieval call binding the contract mdchod 0x0178b8bf.
//
...
// TTL is a free data retrieval call binding the contract mdchod 0x16a25cbd.
//
...
// SetOwner is a paid mutator transaction binding the contract mdchod 0x5b0fc9c3.
//
...
// SetResolver is a paid mutator transaction binding the contract mdchod 0x1896f70a.
//
...
// SetSubnodeOwner is a paid mutator transaction binding the contract mdchod 0x06ab5923.
//
...
// SetTTL is a paid mutator transaction binding the contract mdchod 0x14ab9038.
//
