...
// Package chequebook package wraps the 'chequebook' Deltachain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in deltachain; (auto)cashing cheques in deltachain
// as well as (auto)depositing deltachain to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/contracts/chequebook/contract"
	...
	"github.com/deltachaineum/go-deltachaineum/swarm/services/swap/swap"
)
...
// * depositing deltachain to the chequebook
// * watching incoming deltachain
...
// Backend wraps all mdchods required for chequebook operation.
...
// Cash is a convenience mdchod to cash any cheque.
...
// Cash cashes the cheque by sending an Deltachain transaction.
