...
var (
	...
	// and accepted by the Deltachain core developers into the Ethash consensus.
	//
	...
	// and accepted by the Deltachain core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whdeltachain the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/deltachaineum/EIPs/issues/150)
	...
	Ethash *EthashConfig `json:"dchash,omitempty"`
...
// IsHomestead returns whdeltachain num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAOFork returns whdeltachain num is either equal to the DAO fork block or greater.
func (c *ChainConfig) IsDAOFork(num *big.Int) bool {
	return isForked(c.DAOForkBlock, num)
}

// IsEIP150 returns whdeltachain num is either equal to the EIP150 fork block or greater.
func (c *ChainConfig) IsEIP150(num *big.Int) bool {
	return isForked(c.EIP150Block, num)
}

// IsEIP155 returns whdeltachain num is either equal to the EIP155 fork block or greater.
func (c *ChainConfig) IsEIP155(num *big.Int) bool {
	return isForked(c.EIP155Block, num)
}

// IsEIP158 returns whdeltachain num is either equal to the EIP158 fork block or greater.
func (c *ChainConfig) IsEIP158(num *big.Int) bool {
	return isForked(c.EIP158Block, num)
}

// IsByzantium returns whdeltachain num is either equal to the Byzantium fork block or greater.
func (c *ChainConfig) IsByzantium(num *big.Int) bool {
	return isForked(c.ByzantiumBlock, num)
}

// IsConstantinople returns whdeltachain num is either equal to the Constantinople fork block or greater.
func (c *ChainConfig) IsConstantinople(num *big.Int) bool {
	return isForked(c.ConstantinopleBlock, num)
}

// IsPetersburg returns whdeltachain num is either
...
// IsEWASM returns whdeltachain num represents a block number after the EWASM fork
...
// CheckCompatible checks whdeltachain scheduled fork transitions have been imported
...
// isForked returns whdeltachain a fork scheduled at block s is active at the given head block.
