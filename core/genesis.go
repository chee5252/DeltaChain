...
func SetupGenesisBlock(db dchdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}
func SetupGenesisBlockWithOverride(db dchdb.Database, genesis *Genesis, constantinopleOverride *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whdeltachain the genesis block is already written.
	if genesis != nil {
...
func (g *Genesis) ToBlock(db dchdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db dchdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db dchdb.Database) *types.Block {
...
func GenesisBlockForTesting(db dchdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Deltachain main net genesis block.
...
// DeveloperGenesisBlock returns the 'gdch --dev' genesis block. Note, this must
// be seeded with the
