...
type journalEntry interface {
	...
	// dirtied returns the Deltachain address modified by this journal entry.
...
// otherwise suggest it as clean. This mdchod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whdeltachain account had already suicided
		prevbalance *big.Int
	}
