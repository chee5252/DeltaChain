...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := dchdb.NewMemDatabase()
	finalDb := dchdb.NewMemDatabase()
...
// https://github.com/deltachaineum/go-deltachaineum/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(dchdb.NewMemDatabase()))
...
// accessor mdchods on the reverted state must match the return value of the equivalent
// mdchods on the replayed state.
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(dchdb.NewMemDatabase()))
...
// checkEqual checks that mdchods of state and checkstate return the same values.
...
// See https://github.com/deltachaineum/go-deltachaineum/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(dchdb.NewMemDatabase()))
