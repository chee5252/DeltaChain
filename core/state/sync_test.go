...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(dchdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db dchdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db dchdb.Database, root common.Hash) error {
...
func checkStateConsistency(db dchdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, dchdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(dchdb.Database), srcRoot)
