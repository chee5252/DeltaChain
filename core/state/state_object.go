...
// stateObject represents an Deltachain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of deltachaineum address of the account
	data     Account
	db       *StateDB
...
// empty returns whdeltachain the account is considered empty.
func (s *stateObject) empty() bool {
	return s.data.Nonce == 0 && s.data.Balance.Sign() == 0 && bytes.Equal(s.data.CodeHash, emptyCodeHash)
}

// Account is the Deltachain consensus representation of accounts.
