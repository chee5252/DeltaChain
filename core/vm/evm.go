...
type Context struct {
	// CanTransfer returns whdeltachain the account contains
	// sufficient deltachain to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers deltachain from one account to the other
...
// EVM is the Deltachain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) deltachaineum virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whdeltachain the max code size has been exceeded
