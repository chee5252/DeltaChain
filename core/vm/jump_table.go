...
type operation struct {
	...
	halts   bool // indicates whdeltachain the operation should halt further execution
	jumps   bool // indicates whdeltachain the program counter should not increment
	writes  bool // determines whdeltachain this a state modifying operation
	valid   bool // indication whdeltachain the retrieved operation is valid and known
	reverts bool // determines whdeltachain the operation reverts state (implicitly halts)
	returns bool // determines whdeltachain the operations sets the return data content
}
