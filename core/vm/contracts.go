...
import (
	...
	"github.com/deltachaineum/go-deltachaineum/crypto/bn256"
	"github.com/deltachaineum/go-deltachaineum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mdchod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Deltachain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Deltachain
...
//
// This mdchod does not require any overflow checking as the input size gas costs
