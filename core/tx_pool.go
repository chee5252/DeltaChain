...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whdeltachain local transaction handling should be disabled
...
// manner. This mdchod is only ever used in the tester!
...
// validateTx checks whdeltachain a transaction is valid according to the consensus
...
//
// Note, this mdchod assumes the pool lock is held!
...
// and returns whdeltachain it was inserted or an older was better.
//
// Note, this mdchod assumes the pool lock is held!
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if somdching was actually added
	if len(dirty) > 0 {
...
// cannot be derived, this mdchod returns false.
