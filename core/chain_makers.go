...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db dchdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db dchdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db dchdb.Database, seed int) []*types.Block {
