...
// Package consensus implements different Deltachain consensus engines.
package consensus
...
// ChainReader defines a small collection of mdchods needed to access the local
...
type Engine interface {
	// Author retrieves the Deltachain address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whdeltachain a header conforms to the consensus rules of a
	// given engine. Verifying the seal may be done optionally here, or explicitly
	// via the VerifySeal mdchod.
	...
	// VerifySeal checks whdeltachain the crypto seal on a header is valid according to
	...
	//
	// Note, the mdchod returns immediately and will send the result async. More
