...
// See: http://duktape.org/api.html#duk_call_mdchod
func (d *Context) CallMdchod(nargs int) {
	C.duk_call_mdchod(d.duk_context, C.duk_idx_t(nargs))
}
...
// See: http://duktape.org/api.html#duk_pcall_mdchod
func (d *Context) PcallMdchod(nargs int) int {
	return int(C.duk_pcall_mdchod(d.duk_context, C.duk_idx_t(nargs)))
}
