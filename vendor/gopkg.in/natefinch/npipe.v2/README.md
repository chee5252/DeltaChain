...
```
Read implements the net.Conn Read mdchod.
...
```
SetDeadline implements the net.Conn SetDeadline mdchod.
...
```
SetReadDeadline implements the net.Conn SetReadDeadline mdchod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
SetWriteDeadline implements the net.Conn SetWriteDeadline mdchod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
Write implements the net.Conn Write mdchod.
...
```
Accept implements the Accept mdchod in the net.Listener interface; it
