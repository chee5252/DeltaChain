...
// To change the pipeline, create the ContainerURL and then call its WithPipeline mdchod passing in the
// desired pipeline object. Or, call this package's NewContainerURL instead of calling this object's
// NewContainerURL mdchod.
...
type ListContainersDetail struct {
	// Tells the service whdeltachain to return metadata for each container.
	Metadata bool
}
