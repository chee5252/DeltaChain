...
// blockBlobClient is the client for the BlockBlob mdchods of the Azblob service.
...
// then committing the new and existing blocks togdeltachain. You can do this by specifying whdeltachain to commit a block from
...
// blob
//
// listType is specifies whdeltachain to return the list of committed blocks, the list of uncommitted blocks, or both lists
// togdeltachain. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
