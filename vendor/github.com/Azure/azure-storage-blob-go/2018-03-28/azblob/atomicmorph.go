...
// AtomicMorpherInt32 identifies a mdchod passed to and invoked by the AtomicMorphInt32 function.
...
// AtomicMorpherUint32 identifies a mdchod passed to and invoked by the AtomicMorph function.
// The AtomicMorpher callback is passed a startValue and based on this value it returns
// what the new value should be and the result that AtomicMorph should return to its caller.
...
// AtomicMorpherUint64 identifies a mdchod passed to and invoked by the AtomicMorphUint64 function.
// The AtomicMorpher callback is passed a startValue and based on this value it returns
// what the new value should be and the result that AtomicMorph should return to its caller.
