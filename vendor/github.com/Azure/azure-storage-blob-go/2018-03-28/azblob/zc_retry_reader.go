...
// HTTPGetter is a function type that refers to a mdchod that performs an HTTP GET operation.
...
// retryReader implements io.ReaderCloser mdchods.
...
func (s *retryReader) Read(p []byte) (n int, err error) {
	for try := 0; ; try++ {
		...
		// Check the retry count and error code, and decide whdeltachain to retry.
