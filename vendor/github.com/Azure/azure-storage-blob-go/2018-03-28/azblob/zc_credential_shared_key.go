...
type SharedKeyCredential struct {
	// Only the NewSharedKeyCredential mdchod should set these; all other mdchods should treat them as read-only
	accountName string
	accountKey  []byte
}
...
// credentialMarker is a package-internal mdchod that exists just to satisfy the Credential interface.
