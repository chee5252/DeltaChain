...
// Initialize an instance of this type and then call its String mdchod to set AccountSASSignatureValues's Permissions field.
...
// Call this mdchod to set AccountSASSignatureValues's Permissions field.
...
// Initialize an instance of this type and then call its String mdchod to set AccountSASSignatureValues's Services field.
type AccountSASServices struct {
	Blob, Queue, File bool
}

// String produces the SAS services string for an Azure Storage account.
// Call this mdchod to set AccountSASSignatureValues's Services field.
...
// Initialize an instance of this type and then call its String mdchod to set AccountSASSignatureValues's ResourceTypes field.
type AccountSASResourceTypes struct {
	Service, Container, Object bool
}

// String produces the SAS resource types string for an Azure Storage account.
// Call this mdchod to set AccountSASSignatureValues's ResourceTypes field.
