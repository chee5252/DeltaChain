...
// containerClient is the client for the Container mdchods of the Azblob service.
...
// Containers, Blobs, and Metadata for more information. access is specifies whdeltachain data in the container may be
...
// GetAccessPolicy gets the permissions for the specified container. The permissions indicate whdeltachain container data
...
// SetAccessPolicy sets the permissions for the specified container. The permissions indicate whdeltachain blobs in a
...
// href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
// Timeouts for Blob Service Operations.</a> leaseID is if specified, the operation only succeeds if the container's
// lease is active and matches this ID. access is specifies whdeltachain data in the container may be accessed publicly and
