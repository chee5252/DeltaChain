...
// blobClient is the client for the Blob mdchods of the Azblob service.
...
// rangeGetContentMD5 is when set to true and specified togdeltachain with the Range, the service returns the MD5 hash for
