...
// Initialize an instance of this type and then call its String mdchod to set BlobSASSignatureValues's Permissions field.
type ContainerSASPermissions struct {
	Read, Add, Create, Write, Delete, List bool
}

// String produces the SAS permissions string for an Azure Storage container.
// Call this mdchod to set BlobSASSignatureValues's Permissions field.
