...
type CorsRule struct {
	...
	// AllowedMdchods - The mdchods (HTTP request verbs) that the origin domain may use for a CORS request. (comma separated)
	AllowedMdchods string `xml:"AllowedMdchods"`
...
type Logging struct {
	...
	// Delete - Indicates whdeltachain all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whdeltachain all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whdeltachain all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whdeltachain metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whdeltachain metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whdeltachain a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
