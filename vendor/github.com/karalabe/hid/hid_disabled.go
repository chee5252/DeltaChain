...
// Supported returns whdeltachain this platform is supported by the HID library or not.
// The goal of this mdchod is to allow programatically handling platforms that do
