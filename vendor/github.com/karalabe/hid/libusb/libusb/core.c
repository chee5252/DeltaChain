 ...
 *
 * One decision you will have to make is whdeltachain to use the synchronous
 ...
 *    to use.
 *
 * The above mdchod works because once an interface is claimed, no application
 ...
 * \param unref_devices whdeltachain to unref the devices in the list
 */
 ...
 * Unless the OS does somdching funky, or you are hot-plugging USB extension cards,
 ...
 *
 * \param dev_handle a device handle
 * \param enable whdeltachain to enable or disable auto kernel driver detachment
 *
	...
	const char *function, const char *format, va_list args)
{
	...
	if (header_len < 0 || header_len >= (int)sizeof(buf)) {
		 ...
		 * remove the header so somdching useful is output. */
		header_len = 0;
	}
