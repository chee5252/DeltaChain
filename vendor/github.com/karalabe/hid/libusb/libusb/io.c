 ...
 *
 * In pseudo-code, you want somdching that looks like:
\code
// initialise libusb
 ...
 * does somdching similar, albeit more advanced due to the complications
...
int API_EXPORTED libusb_submit_transfer(struct libusb_transfer *transfer)
{
	 ...
	 * some backends the submit_transfer mdchod is synchroneous.
	 */
	usbi_mutex_unlock(&ctx->flying_transfers_lock);
 ...
 * finer control over whdeltachain this function is blocking or non-blocking, or
...
/** \ingroup libusb_poll
 * Determines whdeltachain your application must apply special timing considerations
 ...
 * This function allows you to detect whdeltachain you are running on such a
 * platform.
 *
 * Since v1.0.5.
 *
