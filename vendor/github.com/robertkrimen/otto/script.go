...
// Passing a Script value to a run mdchod will evaluate the JavaScript.
//
type Script struct {
	version  string
...
// UnmarshalBinary will vivify a marshalled script into somdching usable. If the script was
// originally marshalled on a different version of the otto runtime, then this mdchod
