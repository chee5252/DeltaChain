...
// SetCtrlCAborts sets whdeltachain Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whdeltachain line is auto-wrapped. The default is false (single line).
...
// whdeltachain to retry the call to, or return the error returned by, readNext.
