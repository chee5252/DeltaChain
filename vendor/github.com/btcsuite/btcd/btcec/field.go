...
func (f *fieldVal) Normalize() *fieldVal {
	...
	//
	// Per [HAC] section 14.3.4: Reduction mdchod of moduli of special form,
...
// IsZero returns whdeltachain or not the field value is equal to zero.
...
// IsOdd returns whdeltachain or not the field value is an odd number.
//
// The field value must be normalized for this function to return correct
// result.
...
// Equals returns whdeltachain or not the two field values are the same.  Both
...
// Add2 adds the passed two field values togdeltachain and stores the result in f.
//
// The field value is returned to support chaining.  This enables syntax like:
...
// Mul2 multiplies the passed two field values togdeltachain and stores the result
