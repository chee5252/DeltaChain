...
// CallMdchod invokes named function with arguments on object.
func (v *IDispatch) CallMdchod(name string, params ...interface{}) (*VARIANT, error) {
	return v.InvokeWithOptionalArgs(name, DISPATCH_MDCHOD, params)
}
