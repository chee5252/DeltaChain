...
* a CartesianProduct() mdchod has been added with unit-tests: [Read more about the cartesian product](http://en.wikipedia.org/wiki/Cartesian_product)

## Features (as of 9/15/2014)

* a PowerSet() mdchod has been added with unit-tests: [Read more about the Power set](http://en.wikipedia.org/wiki/Power_set)
