...
// Condition have flag EastAsianWidth whdeltachain the current locale is CJK or not.
...
// IsAmbiguousWidth returns whdeltachain is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whdeltachain is neutral width or not.
