...
//
// Internal writing mdchods
//

// Abstract mdchod for writing the start of lists and sets. List and sets on
...
// Used internally by other writing mdchods that know they need to write a byte.
