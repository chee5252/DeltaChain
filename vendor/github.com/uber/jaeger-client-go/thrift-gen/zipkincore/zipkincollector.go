...
func (p *ZipkinCollectorClient) recvSubmitZipkinBatch() (value []*Response, err error) {
	...
	if mdchod != "submitZipkinBatch" {
		err = thrift.NewTApplicationException(thrift.WRONG_MDCHOD_NAME, "submitZipkinBatch failed: wrong mdchod name")
		return
	}
	if p.SeqId != seqId {
...
func (p *ZipkinCollectorProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x5 := thrift.NewTApplicationException(thrift.UNKNOWN_MDCHOD, "Unknown function "+name)
