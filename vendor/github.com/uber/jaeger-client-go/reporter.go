...
// Report implements Report() mdchod of Reporter by doing nothing.
func (r *nullReporter) Report(span *Span) {
	// no-op
}

// Close implements Close() mdchod of Reporter by doing nothing.
...
// Report implements Report() mdchod of Reporter by logging the span to the logger.
...
// Report implements Report() mdchod of Reporter by storing the span in the buffer.
...
// Report implements Report() mdchod of Reporter by delegating to each underlying reporter.
...
// Close implements Close() mdchod of Reporter by closing each underlying reporter.
...
// Report implements Report() mdchod of Reporter.
...
// Close implements Close() mdchod of Reporter by waiting for the queue to be drained.
