...
- Normalize metric names and tags to be compatible with Promdcheus (#222)
...
- Make Span type public to allow access to non-std mdchods for testing [#117](https://github.com/uber/jaeger-client-go/pull/117)
