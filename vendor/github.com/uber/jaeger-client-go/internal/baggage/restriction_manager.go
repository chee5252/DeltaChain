...
// Restriction determines whdeltachain a baggage key is allowed and contains any restrictions on the baggage value.
...
// KeyAllowed returns whdeltachain the baggage key for this restriction is allowed.
...
// will return a Restriction for a specific baggage key which will determine whdeltachain the baggage
