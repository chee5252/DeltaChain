...
type Tracer struct {
	...
	options struct {
		poolSpans            bool
		gen128Bit            bool // whdeltachain to generate 128bit trace IDs
...
// StartSpan implements StartSpan() mdchod of opentracing.Tracer.
...
func (t *Tracer) startSpanWithOptions(
	...
	// Predicate whdeltachain the given span context is a valid reference
...
// Inject implements Inject() mdchod of opentracing.Tracer
...
// Extract implements Extract() mdchod of opentracing.Tracer
