...
// in order to distinguish whdeltachain current folder should be re-registered in
...
// watched is made in order to check whdeltachain an action comes from a directory or
...
// gensys decides whdeltachain the Windows action, system-independent event or both
