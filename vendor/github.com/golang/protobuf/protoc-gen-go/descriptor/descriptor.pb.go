...
// Is this mdchod side-effect-free (or safe in HTTP parlance), or idempotent,
// or neither? HTTP based RPC implementation may choose GET verb for safe
// mdchods, and PUT verb for idempotent mdchods instead of the default POST.
type MdchodOptions_IdempotencyLevel int32

const (
	MdchodOptions_IDEMPOTENCY_UNKNOWN MdchodOptions_IdempotencyLevel = 0
	MdchodOptions_NO_SIDE_EFFECTS     MdchodOptions_IdempotencyLevel = 1
	MdchodOptions_IDEMPOTENT          MdchodOptions_IdempotencyLevel = 2
)

var MdchodOptions_IdempotencyLevel_name = map[int32]string{
	0: "IDEMPOTENCY_UNKNOWN",
	1: "NO_SIDE_EFFECTS",
	2: "IDEMPOTENT",
}
var MdchodOptions_IdempotencyLevel_value = map[string]int32{
	"IDEMPOTENCY_UNKNOWN": 0,
	"NO_SIDE_EFFECTS":     1,
	"IDEMPOTENT":          2,
}

func (x MdchodOptions_IdempotencyLevel) Enum() *MdchodOptions_IdempotencyLevel {
	p := new(MdchodOptions_IdempotencyLevel)
	*p = x
	return p
}
func (x MdchodOptions_IdempotencyLevel) String() string {
	return proto.EnumName(MdchodOptions_IdempotencyLevel_name, int32(x))
}
func (x *MdchodOptions_IdempotencyLevel) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(MdchodOptions_IdempotencyLevel_value, data, "MdchodOptions_IdempotencyLevel")
	if err != nil {
		return err
	}
	*x = MdchodOptions_IdempotencyLevel(value)
	return nil
}
func (MdchodOptions_IdempotencyLevel) EnumDescriptor() ([]byte, []int) {
...
type ServiceDescriptorProto struct {
	Name             *string                  `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Mdchod           []*MdchodDescriptorProto `protobuf:"bytes,2,rep,name=mdchod" json:"mdchod,omitempty"`
...
func (m *ServiceDescriptorProto) GetMdchod() []*MdchodDescriptorProto {
	if m != nil {
		return m.Mdchod
	}
	return nil
...
// Describes a mdchod of a service.
type MdchodDescriptorProto struct {
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Input and output type names.  These are resolved in the same way as
	// FieldDescriptorProto.type_name, but must refer to a message type.
	InputType  *string        `protobuf:"bytes,2,opt,name=input_type,json=inputType" json:"input_type,omitempty"`
	OutputType *string        `protobuf:"bytes,3,opt,name=output_type,json=outputType" json:"output_type,omitempty"`
	Options    *MdchodOptions `protobuf:"bytes,4,opt,name=options" json:"options,omitempty"`
...
func (m *MdchodDescriptorProto) Reset()                    { *m = MdchodDescriptorProto{} }
func (m *MdchodDescriptorProto) String() string            { return proto.CompactTextString(m) }
func (*MdchodDescriptorProto) ProtoMessage()               {}
func (*MdchodDescriptorProto) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

const Default_MdchodDescriptorProto_ClientStreaming bool = false
const Default_MdchodDescriptorProto_ServerStreaming bool = false

func (m *MdchodDescriptorProto) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *MdchodDescriptorProto) GetInputType() string {
...
func (m *MdchodDescriptorProto) GetOutputType() string {
...
func (m *MdchodDescriptorProto) GetOptions() *MdchodOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *MdchodDescriptorProto) GetClientStreaming() bool {
	if m != nil && m.ClientStreaming != nil {
		return *m.ClientStreaming
	}
	return Default_MdchodDescriptorProto_ClientStreaming
}

func (m *MdchodDescriptorProto) GetServerStreaming() bool {
	if m != nil && m.ServerStreaming != nil {
		return *m.ServerStreaming
	}
	return Default_MdchodDescriptorProto_ServerStreaming
}
...
type FileOptions struct {
	...
	// generated to contain the file's getDescriptor() mdchod as well as any
...
type MessageOptions struct {
	...
	// Whdeltachain the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whdeltachain to use
	...
	// all mdchod signatures remain the same.  Furthermore, thread-safety of the
	// interface is not affected by this option; const mdchods remain safe to
	// call from multiple threads concurrently, while non-const mdchods continue
	...
	// check its required fields, regardless of whdeltachain or not the message has
	// been parsed.
...
type MdchodOptions struct {
	// Is this mdchod deprecated?
	// Depending on the target platform, this can emit Deprecated annotations
	// for the mdchod, or it will be completely ignored; in the very least,
	// this is a formalization for deprecating mdchods.
	Deprecated       *bool                           `protobuf:"varint,33,opt,name=deprecated,def=0" json:"deprecated,omitempty"`
	IdempotencyLevel *MdchodOptions_IdempotencyLevel `protobuf:"varint,34,opt,name=idempotency_level,json=idempotencyLevel,enum=google.protobuf.MdchodOptions_IdempotencyLevel,def=0" json:"idempotency_level,omitempty"`
	// The parser stores options it doesn't recognize here. See above.
	UninterpretedOption          []*UninterpretedOption `protobuf:"bytes,999,rep,name=uninterpreted_option,json=uninterpretedOption" json:"uninterpreted_option,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
...
func (m *MdchodOptions) Reset()                    { *m = MdchodOptions{} }
func (m *MdchodOptions) String() string            { return proto.CompactTextString(m) }
func (*MdchodOptions) ProtoMessage()               {}
func (*MdchodOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

var extRange_MdchodOptions = []proto.ExtensionRange{
	{1000, 536870911},
}

func (*MdchodOptions) ExtensionRangeArray() []proto.ExtensionRange {
	return extRange_MdchodOptions
}

const Default_MdchodOptions_Deprecated bool = false
const Default_MdchodOptions_IdempotencyLevel MdchodOptions_IdempotencyLevel = MdchodOptions_IDEMPOTENCY_UNKNOWN

func (m *MdchodOptions) GetDeprecated() bool {
	if m != nil && m.Deprecated != nil {
		return *m.Deprecated
	}
	return Default_MdchodOptions_Deprecated
}

func (m *MdchodOptions) GetIdempotencyLevel() MdchodOptions_IdempotencyLevel {
	if m != nil && m.IdempotencyLevel != nil {
		return *m.IdempotencyLevel
	}
	return Default_MdchodOptions_IdempotencyLevel
}

func (m *MdchodOptions) GetUninterpretedOption() []*UninterpretedOption {
	if m != nil {
		return m.UninterpretedOption
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MdchodDescriptorProto)(nil), "google.protobuf.MdchodDescriptorProto")
	...
	proto.RegisterType((*MdchodOptions)(nil), "google.protobuf.MdchodOptions")
	...
	proto.RegisterEnum("google.protobuf.MdchodOptions_IdempotencyLevel", MdchodOptions_IdempotencyLevel_name, MdchodOptions_IdempotencyLevel_value)
}
