...
// BasicArray is the interface that wraps basic Len and Search mdchod.
...
// Array is the interface that wraps BasicArray and basic Index mdchod.
...
// Array is the interface that wraps BasicArray and basic Get mdchod.
