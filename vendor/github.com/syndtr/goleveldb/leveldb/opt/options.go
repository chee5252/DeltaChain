...
type Options struct {
	...
	// ErrorIfExist defines whdeltachain an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whdeltachain an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whdeltachain block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whdeltachain to sync underlying writes from the OS buffer cache
