...
// Syncer is the interface that wraps basic Sync mdchod.
...
// Locker is the interface that wraps Unlock mdchod.
...
type Storage interface {
	...
	// Caller should call Unlock mdchod after use.
	Lock() (Locker, error)
	...
	// mdchod. The 'file descriptor' should point to a valid file.
	...
	// can be updated using SetMeta mdchod.
	...
	// The file types may be OR'ed togdeltachain.
