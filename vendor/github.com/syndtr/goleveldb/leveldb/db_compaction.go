...
func (db *DB) compactionTransact(name string, t compactionTransactInterface) {
	...
	for n := 0; ; n++ {
		// Check whdeltachain the DB is closed.
		if db.isClosed() {
...
// resumeWrite returns an indicator whdeltachain we should resume write operation if enough level0 files are compacted.
