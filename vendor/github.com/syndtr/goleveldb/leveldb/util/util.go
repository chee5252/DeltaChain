...
// Releaser is the interface that wraps the basic Release mdchod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser mdchod.
...
// Released returns whdeltachain Release mdchod already called.
