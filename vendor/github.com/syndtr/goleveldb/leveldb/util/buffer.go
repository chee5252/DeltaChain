...
// A Buffer is a variable-sized buffer of bytes with Read and Write mdchods.
...
// are no intervening mdchod calls on the Buffer.
...
// The slice is only valid until the next call to a read or write mdchod.
