...
// isWhitespace reports whdeltachain the type is considered a whitespace type for the
// line break rules.
...
// isRemovedByX9 reports whdeltachain the type is one of the types removed in X9.
