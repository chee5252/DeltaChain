...
//go:cgo_import_dynamic libc_sdchostname sdchostname "libc.a/shr_64.o"
...
//go:linkname libc_sdchostname libc_sdchostname
...
func callsdchostname(_p0 uintptr, _lenp0 int) (r1 uintptr, e1 Errno) {
	r1, _, e1 = syscall6(uintptr(unsafe.Pointer(&libc_sdchostname)), 2, _p0, uintptr(_lenp0), 0, 0, 0, 0)
	return
}
