...
// already exists, regardless of whdeltachain O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whdeltachain the original call had it set.
...
// them to the FUSE server. Without this, writdchrough caching is
// used.
